                    ...
                    <div className="w-full divide-y divide-gray-200">
                        ...
                        {selectedFile && (
                            <div className="relative">
                                <XIcon onClick={() => setSelectedFile(null)} className="boorder h-7 text-black absolute cursor-pointer shadow-md border-white m-1 rounded-full" />

...
export default function Input() {
    return (
        <div className="flex border-b border-gray-200  p-3 space-x-3 ">
            ...
            <img src="https://pbs.twimg.com/profile_images/1275011169628160000/PvZw734h_400x400.jpg" alt="user-img" className="h-11 w-11 rounded-full cursor-pointer hover:brightness-95" />
